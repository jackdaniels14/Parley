...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary: 'bg-primary-600 text-white hover:bg-primary-700 focus:ring-primary-500 dark:bg-violet-600 dark:hover:bg-violet-700 dark:focus:ring-violet-500',
      ...
      outline: 'border-2 border-gray-300 bg-transparent hover:bg-gray-100 focus:ring-gray-500 dark:border-gray-700 dark:hover:bg-gray-800 dark:text-gray-100',
